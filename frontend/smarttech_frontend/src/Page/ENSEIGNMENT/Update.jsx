          ...
          const token = localStorage.getItem("auth-token");
            ...
            try {
              const response = await fetch(`http://localhost:9000/api/updateInfo/${id}`,{
                ...
                if (response.ok) {
                  toast.error("Your information was updated successfully")
                } else {
                        ...
                        <form class="w-full" onSubmit={(e) => {e.preventDefault(); update() }} >
                            ...
                            <div class="w-full">
                              ...
                              <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
                                ...
                                <select name="specialitée" id="specialitée"  class="appearance-none block w-full bg-gray-50 text-gray-700 border border-gray-300 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" value={formData.specialitée} onChange={changeHandler} >
